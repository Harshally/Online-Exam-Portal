...
<!--Body Starts Here-->
        <div class="main">
            <div class="content">
                ...
                Test: <span class="heavy"><?php echo $faculty_name; ?></span>&nbsp;&nbsp;
                            ...
                            if(isset($_POST['submit']))
                            {
                                ...
                                if($res===true)
                                {
                                    ...
                                    */
                                    ...
                                    if($faculty=='1')
                                    {
                                        header('location:'.SITEURL.'index.php?page=question&test=1');
                                    }
                                    if($faculty=='2')
                                    {
                                        header('location:'.SITEURL.'index.php?page=question&test=2');
                                    }
